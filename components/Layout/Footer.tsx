    ...
    <div className="flex flex-col">
      ...
      <div className="text-center px-4 py-2">
        ...
        <p className="mt-3 text-[14px] text-gray-600">
          If the chat does not return a response within 30 seconds, either the AI Provider (Anthropic) servers are down or the API account funding has run dry. To donate and keep Rabbi Eliyahu alive:&nbsp;
          <a 
